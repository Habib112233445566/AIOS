...
### 8.11 Linux Base Image Build Subsystem (`aiosh-core::base_image` & `aiosh-core::base_image_service`, T-01101..T-01200)
...
**Core Service & Registry (`aiosh-core::base_image_service`):**
- Image Registry: `ImageStore` seeded with canonical reference targets (`debian-12-minimal-raw`, `debian-12-minimal-qcow2`, `debian-12-minimal-iso`, `alpine-319-container-tarball`).
- Build Planning Engine: `generate_build_plan` synthesizes a 4-stage deterministic build plan (`bootstrap`, `kernel_and_boot`, `system_config`, `artifact_packaging`) with duration/size estimation.
